...
public class InstallAlert {
  public static void main(String[] args) throws IOException {
    ...
    Path filePathObj = Paths.get(System.getProperty("user.home") + File.separator + "Shuffleboard"
        + File.separator + "plugins" + File.separator + "NetworkAlerts.jar");
    ...
    if (!fileExists) {
      ...
      try {
        ...
        fOutStream = new FileOutputStream(System.getProperty("user.home") + File.separator
            + "Shuffleboard" + File.separator + "plugins" + File.separator + "NetworkAlerts.jar");
