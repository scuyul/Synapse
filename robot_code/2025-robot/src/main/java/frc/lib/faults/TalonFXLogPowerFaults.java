...
public class TalonFXLogPowerFaults {
  ...
  public static void setupChecks(TalonFXWrapper wrapper) {
    ...
    var stickyFaults = List.of(
        new StickyFaults(wrapper.getName(), talonFX.getStickyFault_BootDuringEnable(),
            talonFX::clearStickyFault_BootDuringEnable),
        new StickyFaults(wrapper.getName(), talonFX.getStickyFault_BridgeBrownout(),
            talonFX::clearStickyFault_BridgeBrownout),
        new StickyFaults(wrapper.getName(), talonFX.getStickyFault_DeviceTemp(),
            talonFX::clearStickyFault_DeviceTemp),
        new StickyFaults(wrapper.getName(), talonFX.getStickyFault_ForwardHardLimit(),
        ...
        new StickyFaults(wrapper.getName(), talonFX.getStickyFault_FusedSensorOutOfSync(),
            talonFX::clearStickyFault_FusedSensorOutOfSync),
        new StickyFaults(wrapper.getName(), talonFX.getStickyFault_Hardware(),
            talonFX::clearStickyFault_Hardware),
        new StickyFaults(wrapper.getName(), talonFX.getStickyFault_MissingDifferentialFX(),
            talonFX::clearStickyFault_MissingDifferentialFX),
        new StickyFaults(wrapper.getName(), talonFX.getStickyFault_OverSupplyV(),
            talonFX::clearStickyFault_OverSupplyV),
        new StickyFaults(wrapper.getName(), talonFX.getStickyFault_ProcTemp(),
            talonFX::clearStickyFault_ProcTemp),
        new StickyFaults(wrapper.getName(), talonFX.getStickyFault_RemoteSensorDataInvalid(),
            talonFX::clearStickyFault_RemoteSensorDataInvalid),
        new StickyFaults(wrapper.getName(), talonFX.getStickyFault_RemoteSensorPosOverflow(),
            talonFX::clearStickyFault_RemoteSensorPosOverflow),
        new StickyFaults(wrapper.getName(), talonFX.getStickyFault_RemoteSensorReset(),
            talonFX::clearStickyFault_RemoteSensorReset),
        new StickyFaults(wrapper.getName(), talonFX.getStickyFault_ReverseHardLimit(),
        ...
        new StickyFaults(wrapper.getName(), talonFX.getStickyFault_StatorCurrLimit(),
            talonFX::clearStickyFault_StatorCurrLimit),
        new StickyFaults(wrapper.getName(), talonFX.getStickyFault_SupplyCurrLimit(),
            talonFX::clearStickyFault_SupplyCurrLimit),
        new StickyFaults(wrapper.getName(), talonFX.getStickyFault_Undervoltage(),
            talonFX::clearStickyFault_Undervoltage),
        new StickyFaults(wrapper.getName(), talonFX.getStickyFault_UnlicensedFeatureInUse(),
            // unable to find clearStickyFault for UnlicensedFeatureInUse
            (double timeoutSecs) -> StatusCode.OK),
        new StickyFaults(wrapper.getName(), talonFX.getStickyFault_UnstableSupplyV(),
            talonFX::clearStickyFault_UnstableSupplyV),
        new StickyFaults(wrapper.getName(),
