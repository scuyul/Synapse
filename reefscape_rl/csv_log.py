        ...
        self._writer.writerow(
            {
                ...
                "/Sim/TargetLevelCode": info["target_level_code"],
                "/Sim/ScoredLevelCode": info["scored_level_code"],
                ...
                "/RL/Action/scoreLevel": f"{float(action[5]) if len(action) > 5 else 0.75:.6f}",
